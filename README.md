...
A sample Twig template is included in [App/Views/Home/index.html](App/Views/Home/index.twig) that inherits from the base template in [App/Views/base.html](App/Views/base.html).
